...
import com.qtpselenium.framework.datadriven.CustomListener;
...
public class SendMailTest extends TestBase{
	...
	public void sendmailtest(){
	            TestBase.zip(System.getProperty("user.dir")+"//target//Reports//"+CustomListener.resultFolderName);
                ...
                SendMailTest.sendMail("vidhya@i-waves.com",
                		            "testing1",
                		            "smtp.gmail.com",
                		            "465",
                		            "true",
       ...
       // props.put("mail.smtps.auth", "true");
...

        {
            ...
            msg.setFrom(new InternetAddress("vidhya@i-waves.com"));
